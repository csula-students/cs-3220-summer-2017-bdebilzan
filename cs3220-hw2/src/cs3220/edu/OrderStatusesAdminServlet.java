...
public class OrderStatusesAdminServlet extends HttpServlet {
	...
	public void doGet( HttpServletRequest request, HttpServletResponse response)
		...
		"}</style>");
		out.println("<img src = 'https://logopond.com/logos/936fb12d35d4bb7f4f9d6c3085caa4e4.png' width= '180' height='180'> The Bistro - Admin" );
		...
		for (Order entry: entries) {
			out.println(
				"<tr>" + 
					...
					"<td><a href='/cs3220-hw2/admin/order?id=" + entry.getId() + "'>Edit</a>" +
				"</tr>"
			);
		}
		out.println("</table>");
